...
class exercises(Scene):
    def construct(self):
        ...
        a1 = Text("Parent function").next_to(trans1a, LEFT).scale(0.5)
        trans1b = Tex("$y = |x + 4|$").next_to(trans1a,DOWN)
        b1 = Text("Shift LEFT 4 units").next_to(trans1b, LEFT).scale(0.5)
        trans1c = Tex("$y = -|x + 4|$").next_to(trans1b, DOWN)
        c1 = Text("Reflect across x axis").next_to(trans1c, LEFT).scale(0.5)
        trans1d = Tex("$y = -|x + 4| - 7$").next_to(trans1c, DOWN)
        d1= Text("Shift DOWN 7 units").next_to(trans1d, LEFT, buff=-0.5).scale(0.5)
        
        trans2 = Text("y = 2|x - 1| + 3").next_to(trans, DOWN).scale(0.5)
        trans2a = Tex("$y = |x|$").next_to(trans2, DOWN)
        a2 = Text("Parent function").next_to(trans2a, LEFT).scale(0.5)
        trans2b = Tex("$y = |x - 1|$").next_to(trans2a,DOWN)
        b2 = Text("Shift RIGHT 1 unit").next_to(trans2b, LEFT).scale(0.5)
        trans2c = Tex("$y = 2|x - 1|$").next_to(trans2b, DOWN)
        c2 = Text("Stretch the function").next_to(trans2c, LEFT).scale(0.5)
        trans2d = Tex("$y = 2|x - 1| + 3$").next_to(trans2c, DOWN)
        d2= Text("Shift UP 3 units").next_to(trans2d, LEFT, buff=-0.5).scale(0.5)
        ...
        trans3a = Tex("$y = |x|$").next_to(trans3, DOWN)
        a3 = Text("Parent function").next_to(trans3a, LEFT).scale(0.5)
        trans3b = Tex("$y = |x + 4|$").next_to(trans3a,DOWN)
        b3 = Text("Translate LEFT 4 units").next_to(trans3b, LEFT, buff=-1).scale(0.5)
        trans3c = Tex("$y = |x + 4| - 7$").next_to(trans3b, DOWN)
        c3 = Text("Translate DOWN 7 units").next_to(trans3c, LEFT, buff=-1).scale(0.5)
        ...
        a4 = Text("Parent function").next_to(trans4a, LEFT).scale(0.5)
        trans4b = Tex("$y = (x - 3)^2$").next_to(trans4a,DOWN)
        b4 = Text("Translate RIGHT 3 units").next_to(trans4b, LEFT, buff=-1).scale(0.5)
        trans4c = Tex("$y = 2(x - 3)^2$").next_to(trans4b, DOWN)
        c4 = Text("Stretch by a factor of 2").next_to(trans4c, LEFT, buff=-1).scale(0.5)
